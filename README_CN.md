...
- 🔑 **TOTP 双重因子验证** (v1.0.5)：
  ...
  - 桌面端：列表+详情面板布局，弹窗添加
  - 移动端：卡片列表，一键复制
- 🗂️ **分组管理** (v1.0.5)：将密码组织到文件夹中（最多5个分组），紧凑 + 按钮
- 🛡️ **生物识别认证** (v1.0.3)：
  - 指纹解锁进入应用（无需主密码）
...
- [x] **桌面端弹窗修改密码** (v1.0.3)
- [x] **TOTP 双重因子验证**，支持二维码扫描 (v1.0.5)
- [x] **二维码图片上传和剪贴板粘贴**用于 TOTP 设置 (v1.0.5)
- [x] **统一桌面端页面标题样式** (v1.0.5)
- [x] **桌面端列表+详情面板布局**用于 TOTP (v1.0.5)
